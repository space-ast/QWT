...
Plot::Plot(QWidget* parent) : QwtPlot(parent), m_paintedPoints(0), m_interval(0.0, 10.0), m_timerId(-1)
{
...
{
    m_interval = QwtInterval(m_interval.maxValue(), m_interval.maxValue() + m_interval.width());
