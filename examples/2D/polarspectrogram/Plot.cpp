...
{
public:
    Picker(QwtPolarCanvas* canvas) : QwtPolarPicker(canvas)
    {
...
Plot::Plot(QWidget* parent) : QwtPolarPlot(parent)
{
    ...
    m_spectrogram->setPaintAttribute(QwtPolarSpectrogram::ApproximatedAtan, true);
    ...
    new QwtPolarCachePanner(canvas());
}
