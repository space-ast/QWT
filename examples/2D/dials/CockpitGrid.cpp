...
{
public:
    Clock(QWidget* parent = NULL) : QwtAnalogClock(parent)
    {
#if 0
            // disable minor ticks
...
{
public:
    Speedo(QWidget* parent = NULL) : SpeedoMeter(parent)
    {
...
private:
    void changeSpeed()
    {
        ...
        if ((speed < 7.0 && offset < 0.0) || (speed > 203.0 && offset > 0.0)) {
            offset = -offset;
        }
...
{
public:
    AttitudeInstrument(QWidget* parent = NULL) : AttitudeIndicator(parent)
    {
