...
AttitudeIndicator::AttitudeIndicator(QWidget* parent) : QwtDial(parent), m_gradient(0.0)
{
...
void AttitudeIndicator::drawScale(QPainter* painter, const QPointF& center, double radius) const
{
...
void AttitudeIndicator::drawScaleContents(QPainter* painter, const QPointF&, double) const
{
