...
{
public:
    ScaleDraw(Qt::Orientation orientation, const QStringList& labels) : m_labels(labels)
    {
...
{
public:
    ChartItem() : QwtPlotBarChart("Page Hits")
    {
...
BarChart::BarChart(QWidget* parent) : QwtPlot(parent)
{
    ...
    } pageHits[] = { { "Arch", 1114, QColor("DodgerBlue") },    { "Debian", 1373, QColor("#d70751") },
                     { "Fedora", 1638, QColor("SteelBlue") },   { "Mageia", 1395, QColor("Indigo") },
                     { "Mint", 3874, QColor(183, 255, 183) },   { "openSuSE", 1532, QColor(115, 186, 37) },
                     { "Puppy", 1059, QColor("LightSkyBlue") }, { "Ubuntu", 2391, QColor("FireBrick") } };
...
{
    const Qt::Orientation orientation = (o == 0) ? Qt::Vertical : Qt::Horizontal;
